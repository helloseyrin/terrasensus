...
See `docs/engineering-notes/kherson-context.md` for a full account of what is known, what is not known, and what this means for any future deployment in conflict-affected agricultural regions.
